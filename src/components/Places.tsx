  ...
  return (
    <section className="cities__places places">
      ...
      <form className="places__sorting" action="#" method="get">
        ...
        {showSortOptions && (
          <ul className="places__options places__options--custom places__options--opened">
            ...
            <li className="places__option" tabIndex={0} onClick={() => onPlaceSortClick(SortType.PriceDesc)}>Price: high
              to low
            </li>
            <li className="places__option" tabIndex={0} onClick={() => onPlaceSortClick(SortType.RatingDesc)}>Top rated
              first
            </li>
          </ul>
        )}
      ...
      <div className="cities__places-list places__list tabs__content">
        {sortedByPrice(filteredByCity(currentCity), placeSortType).map((offer) => (<PlaceCard key={offer.id}
          offer={offer}
                                                                                   />))}
      </div>
    </section>
